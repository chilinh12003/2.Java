...
public class Deregister
{
	...
	protected void CreateUnSub() throws Exception
	{
		...
		subObj.setDeregDate(MyDate.Date2Timestamp(calCurrent));
	...
	public MTType getMessages(Moqueue moQueueObj, Mode mMode, Service serviceObj) throws Exception
	{
		try
		{
			this.mMode = mMode;
