...
public class LocalConfig
{
	...
	//Thông tin get link
	public static String GetLink_User="vlivepartner";
	public static String GetLink_Password ="vlivepartner@123";
	...
	public static boolean loadProperties(String propFile)
	{
		...
		try
		{
			...
			GetLink_User = properties.getProperty("GetLink_User", GetLink_User);
			GetLink_Password = properties.getProperty("GetLink_Password", GetLink_Password);
