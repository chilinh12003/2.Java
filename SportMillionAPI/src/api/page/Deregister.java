...
public class Deregister extends HttpServlet
{
	...
	private String GetVNPInfo(HttpServletRequest request)
	{
		...
		try
		{
			...
			ProDeregister mProcess = new ProDeregister(MSISDN, RequestID, Keyword,Note, Channel, application, username, userip);
		...
		finally
		{
			...
			MyLogger.WriteDataLog(mCal_RequestDate.getTime(),LocalConfig.LogDataFolder, "_API_VNP", "REQUEST Deregister --> " + XMLRequest);
