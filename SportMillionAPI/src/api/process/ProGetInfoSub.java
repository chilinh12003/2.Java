...
public class ProGetInfoSub
{
	...
	public ProGetInfoSub(String MSISDN, String RequestID, String Code, String Channel, String AppName, String UserName,
			String IP)
	{
		this.MSISDN = MSISDN;
	...
	private String GetResponse(String last_time_subscribe, String last_time_unsubscribe, String last_time_renew,
			String last_time_retry, String expire_time)
	{
		...
		return String.format(Format, new Object[]{mInfoSubResult.GetValue().toString(), mInfoSubResult.toString(),
	...
	public String Process()
	{
		...
		try
		{
			...
			if (mSubObj.IsNull() || (mSubObj.IsDereg && mSubObj.StatusID == Subscriber.Status.UndoSub.GetValue()))
			{
				...
				return GetResponse(last_time_subscribe, last_time_unsubscribe, last_time_renew, last_time_retry,
						expire_time);
			}
