...
public class subscribe
{
	...
	class SubRequest
	{
		...
		public String Register() throws Exception
		{
			...
			mMTType = mReg.getMessages(moQueueObj, mMode, amount);
		...
		public String Restore() throws Exception
		{
			...
			mMTType = mRestore.getMessages(moQueueObj, mMode, amount);
		...
		public String Deregister() throws Exception
		{
			...
			mMTType = mDereg.getMessages(moQueueObj, mMode);
