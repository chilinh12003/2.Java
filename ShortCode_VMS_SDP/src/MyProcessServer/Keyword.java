...
public class Keyword
{
	...
	/**
	 * Danh cho kết nối SDP với mạng VMS cho từng keyword
	 */
	private String VMS_SVID="";
	...
	public void setVMS_SVID(String VMS_SVID)
	{
	...
	public static Hashtable<?, Keyword> retrieveKeyword() throws Exception
	{
		...
		try
		{
			...
			for (int i = 0; i < mTable.GetRowCount(); i++)
			{
				...
				{
					keywordtemp.VMS_SVID = mTable.GetValueAt(i, "VMS_SVID").toString();
				}
