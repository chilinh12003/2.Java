...
public class MyConfig
{
	...
	public static String DomainParameter ="{DNS}";
	public static String Domain="";
	
	public static String log4jConfigPath="log4j.properties";
	public static String hibernateConfigPath ="hibernate.cfg.xml";
}
