...
public class SMPPSender
{
	...
	public static void main(String args[])
	{
		...
		{
			System.out
					.println("Usage: SMPPSender -dest <dest number on international format> -message <the message, within qoutes if contains whitespaces> [-sender <sender id> [-senderTon <sender ton>] [-senderNpi <sender npi>]]");
			System.exit(0);
		}
...
/*
 * $Log: not supported by cvs2svn $ Revision 1.1 2004/09/12 12:37:40 sverkera
 * Added
 */
