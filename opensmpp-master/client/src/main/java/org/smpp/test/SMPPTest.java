...
/**
 * Class <code>SMPPTest</code> shows how to use the SMPP toolkit. You can bound
...
public class SMPPTest
{
	...
	private void bind()
	{
		...
		try
		{
			...
			{
				System.out.println("Invalid mode async/sync, expected a or s, got " + syncMode
						+ ". Operation canceled.");
				return;
			}
			...
			{
				System.out.println("Invalid bind mode, expected t, r or tr, got " + bindOption
						+ ". Operation canceled.");
				return;
			}
	...
	private void loadProperties(String fileName) throws IOException
	{
		...
		{
			System.out.println("The value of bind-mode parameter in " + "the configuration file " + fileName
					+ " is wrong. " + "Setting the default");
			bindMode = "t";
		}
		bindOption = bindMode;
 ...
 * 
 * 
 * Old changelog: 15-09-01 ticp@logica.com added asynchronous processing
 * capability as the library has this feature now 10-10-01 ticp@logica.com file
 * moved to package com.logica.smpp.test, old package com.logica.smpptest not
 * used anymore 11-10-01 ticp@logica.com the max address length checking
 * reflected 11-10-01 ticp@logica.com added commants
 */
