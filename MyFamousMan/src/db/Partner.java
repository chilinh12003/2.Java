...
public class Partner extends DAOBase implements java.io.Serializable
{
	...
	/** full constructor */
	public Partner(String validString, String partnerName, String phone, String email, String address, Short isActive,
			String website, Short partnerTypeId, Integer parentId)
	{
