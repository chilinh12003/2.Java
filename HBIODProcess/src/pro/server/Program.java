...
import pro.check.CheckConfirmExpire;
...
public class Program extends Thread
{
	...
	private void Init() throws Exception
	{
		...
		/*CheckConfirmExpire mCheckExpire = new CheckConfirmExpire();
		mCheckExpire.setPriority(MAX_PRIORITY);
		mCheckExpire.start();*/
	}
