...
public class Preference
{
	...
	public static String[] VALID_SERVICEID = {"9315","1566","9696","1546","9093","9193","9293","9393","9493","9593","9693","9793"};
	...
	public static void loadProperties(String fileName) throws IOException
	{
		...
		{
			Logger.info("Wrong value of bind_mode parameter in " + "the configuration file " + fileName
		...
		PayLoadUDH = Byte.toString((byte) 0x06) + Byte.toString((byte) 0x05) + Byte.toString((byte) 0x04)
				+ Byte.toString((byte) 0x13) + Byte.toString((byte) 0x88) + Byte.toString((byte) 0x00)
