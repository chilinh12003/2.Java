...
public class EMSTools
{
	...
	public static SubmitSM buildSubmitEMSfromBIN(ByteBuffer otaData, String srcAddr, String destAddr, BigDecimal emsId,
			byte registeredDelivery, int MsgType, String sCommand_code, int TotalSegments, BigDecimal RequestID)
			throws EMSException
	{
		...
		try
		{
			...
			if ("SFONE".equalsIgnoreCase(Preference.mobileOperator) && "1".equalsIgnoreCase(Preference.REFUND_ACTIVE))
			{
				...
				else request.setSfoneChargeFlag((short) 0x0000);
			}
	...
	// gsm
	public static Collection buildSubmitEMS(ByteBuffer otaData, String srcAddr, String destAddr, int contentType,
			BigDecimal emsId, byte registeredDelivery, int MsgType, String commandcode) throws EMSException
	{
		...
		try
		{
			...
			for (byte i = 1; i <= totalSegments; i++)
			{
				...
				if (contentType == Constants.CT_WAP_SI || contentType == Constants.CT_MMS_NOTIFY)
				{
	...
	// Sfone
	public static Collection buildSubmitEMS(ByteBuffer otaData, String srcAddr, String destAddr, int contentType,
			BigDecimal emsId, byte registeredDelivery, int MsgType, BigDecimal RequestID, String commandcode)
			throws EMSException
	{
		SubmitSM request = null;
		Vector vRequests = new Vector();
		...
		try
		{
			...
			for (byte i = 1; i <= totalSegments; i++)
			{
				...
				else
				{
					...
					Charge.appendByte((byte) 0xA0);
					Charge.appendString(commandcode + "," + MsgType + "," + TotalSegments);
					request.setSourceSubaddress(Charge);
				}
				...
				Logger.info("SMSCTools.buildSubmitSM", "{RequestID=" + RequestID + "}{srcAddr=" + srcAddr
						+ "}{destAddr=" + destAddr + "}{setDestSubaddress=" + DestSubAddress + "} {chargeflag="
						+ chargeflag + "} ");
	...
	// Dalink
	public static SubmitSM buildSubmitDalink(String srcMsg, String srcAddr, String destAddr, BigDecimal emsId,
			byte registeredDelivery, int MsgType, String sCommand_code, int TotalSegments) throws EMSException
	{
		SubmitSM request = new SubmitSM();
		// t Test = new TLV();
	...
	// Banking
	public static SubmitSM buildSubmitBanking(String srcMsg, String srcAddr, String destAddr, BigDecimal emsId,
			byte registeredDelivery, int MsgType, String sCommand_code, int TotalSegments, String RequestID)
			throws EMSException
	{
		SubmitSM request = new SubmitSM();
		// t Test = new TLV();
		...
		try
		{
			...
			// request.setSfoneChargeFlag((short) 0x0000);
			Logger.info("SMSCTools.buildSubmitSM", "{RequestID=" + RequestID + "}{srcAddr=" + srcAddr + "}{destAddr="
					+ destAddr + "}{setDestSubaddress=" + DestSubAddress + "} {chargeflag=" + chargeflag + "} ");
	...
	// Banking
	public static SubmitSM buildSubmitDPORT(String srcMsg, String srcAddr, String destAddr, BigDecimal emsId,
			byte registeredDelivery, int MsgType, String sCommand_code, int TotalSegments, String RequestID)
			throws EMSException
	{
		SubmitSM request = new SubmitSM();
	...
	public static SubmitSM buildSubmit411A(String srcMsg, String srcAddr, String destAddr, BigDecimal emsId,
			byte registeredDelivery, int MsgType, String sCommand_code, int TotalSegments, String RequestID)
			throws EMSException
	{
		SubmitSM request = new SubmitSM();
	...
	// Dalink VSSA
	public static SubmitSM buildSubmitDalinkVSSA(String srcMsg, String srcAddr, String destAddr, BigDecimal emsId,
			byte registeredDelivery, int MsgType, String sCommand_code, int TotalSegments) throws EMSException
	{
		SubmitSM request = new SubmitSM();
		try
	...
	// Dalink VSSA
	public static SubmitSM buildSubmitMC8000(String srcMsg, String srcAddr, String destAddr, BigDecimal emsId,
			byte registeredDelivery, int MsgType, String sCommand_code, int TotalSegments) throws EMSException
	{
		SubmitSM request = new SubmitSM();
		try
	...
	public static SubmitSM buildSubmitKARAOKE(String srcMsg, String srcAddr, String destAddr, BigDecimal emsId,
			byte registeredDelivery, int MsgType, String sCommand_code, int TotalSegments) throws
	...
	public static Collection buildSubmitEMS(ByteBuffer otaData, String srcAddr, String destAddr, int contentType,
			BigDecimal emsId, byte registeredDelivery, int MsgType, String sCommand_code, int TotalSegments)
			throws EMSException
	{
		SubmitSM request = null;
		Vector vRequests = new Vector();
	...
	public static Collection buildSubmitEMS(String filename, String srcAddress, String destAddress, int contentType,
			int MsgType, String sCommand_code, int TotalSegments) throws EMSException
	{
		SubmitSM request = null;
		Vector vRequests = new Vector();
		try
	...
	// / long message text
	public static Collection buildSubmitLongMsg(String strData, String srcAddr, String destAddr, int contentType,
			BigDecimal emsId, byte registeredDelivery, int MsgType, String commandcode) throws EMSException
	{
		SubmitSM request = null;
		Vector vRequests = new Vector();
		...
		try
		{
			...
			for (int i = 0; i < totalSegs; i++)
			{
				...
				Gateway.util.log("buildSubmitLongMsg", "{splittedMsg[" + i + "]=" + splittedMsg[i] + "}");
				...
				Gateway.util.log("buildSubmitLongMsg", "{request=" + request.debugString() + "}");
				vRequests.addElement(request);
			} // end for
			return vRequests;
		}
	...
	// / long message text
	public static Collection buildSubmitOMA(String strData, String srcAddr, String destAddr, int contentType,
			BigDecimal emsId, byte registeredDelivery, int MsgType, String commandcode) throws EMSException
	{
		SubmitSM request = null;
		Vector vRequests = new Vector();
	...
	public static Collection buildSubmitLongMsg2(String strData, String srcAddr, String destAddr, int contentType,
			BigDecimal emsId, byte registeredDelivery) throws EMSException
	{
		SubmitSM request = null;
		Vector vRequests = new Vector();
