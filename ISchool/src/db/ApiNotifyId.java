...
/**
 * ApiNotifyId entity. @author MyEclipse Persistence Tools
 */

public class ApiNotifyId extends DAOBase implements java.io.Serializable
{
	...
	/** full constructor */
	public ApiNotifyId(Integer logId, Short pid, String phoneNumber)
	{
		this.logId = logId;
		this.pid = pid;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof ApiNotifyId))
			return false;
		ApiNotifyId castOther = (ApiNotifyId) other;
