...
public class MemberLog extends DAOBase implements java.io.Serializable {
	...
	/** full constructor */
	public MemberLog(Integer memberId, String memberName, String tableName,
			Integer actionId, String actionName, String oldData,
			String newData, Boolean isSuccess, String requestIp,
