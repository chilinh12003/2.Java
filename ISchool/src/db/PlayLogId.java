...
/**
 * PlayLogId entity. @author MyEclipse Persistence Tools
 */

public class PlayLogId extends DAOBase implements java.io.Serializable {
	...
	/** full constructor */
	public PlayLogId(Integer logId, String phoneNumber, Short pid) {
		this.logId = logId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PlayLogId))
			return false;
		PlayLogId castOther = (PlayLogId) other;
