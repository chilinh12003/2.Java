...
public class WinnerWeek
{
	...
	public WinnerWeek(DBConfig mConfigObj) throws Exception
	{
		try
		{
	...
	public MyTableModel Select(int Type, String Para_1) throws Exception, SQLException
	{
		try
		{
			...
			return mGet.GetData_Pro("Sp_WinnerWeek_Select", Arr_Name, Arr_Value);
		}
	...
	public boolean Update(int Type, String XMLContent) throws Exception
	{
		try
		{
			...
			return mExec.Execute_Pro("Sp_WinnerWeek_Update", Arr_Name, Arr_Value);
		}
		catch (Exception ex)
		{
			throw ex;
	 ...
	 * @param Type
	 * <br/>
	 *            Type = 0: insert full <br/>
	 *            Type = 1: xóa đi và insert lại
	 * @param XMLContent
	 * @return
	 * @throws Exception
	 * @throws SQLException
	...
	public boolean Insert(int Type, String XMLContent) throws Exception, SQLException
	{
		try
		{
			String[] Arr_Name = {"Type", "XMLContent"};
			String[] Arr_Value = {Integer.toString(Type), XMLContent};
			return mExec.Execute_Pro("Sp_WinnerWeek_Insert", Arr_Name, Arr_Value);
		}
		catch (SQLException ex)
		{
			throw ex;
