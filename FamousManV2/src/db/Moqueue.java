...
public class Moqueue extends DAOBase implements java.io.Serializable {
	...
	/** full constructor */
	public Moqueue(String phoneNumber, String shortCode, Short telcoId,
			String keyword, String mo, Short channelId, String requestId,
			Timestamp moinsertDate, Timestamp receiveDate) {
