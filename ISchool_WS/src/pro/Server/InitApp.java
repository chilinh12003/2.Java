...
public class InitApp implements ServletContextListener
{
	static
	{
		...
		{
			HibernateSessionFactory.ConfigPath = MyFile.ConvertPath(MyCurrent.GetRootPath()  +"/ISchoolWS/Config/hibernate.cfg.xml");
		}
	...
	public void contextInitialized(ServletContextEvent event)
	{
		try
		{
			...
			Program.dicAccount.put("vtischool", "dg3$3RIO)y");
